...
from src.diffwave.model import DiffWave
...
def predict(spectrogram=None, model_dir=None, params=None, device=torch.device('cuda'), fast_sampling=False):
  ...
  with torch.no_grad():
    ...
    audio = torch.randn(spectrogram.shape[0], base_params.hop_samples * spectrogram.shape[-1], device=device)
...
if __name__ == '__main__':
  parser = ArgumentParser(description='runs inference on a spectrogram file generated by src.preprocess')
  parser.add_argument('model_dir',
      help='directory containing a trained model (or full path to weights.pt file)')
  parser.add_argument('--spectrogram_path', '-s',
      help='path to a spectrogram file generated by src.preprocess')
